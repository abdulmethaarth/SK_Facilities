package com.affinity.sk_facilities.countrypicker;
...
public class CountryPickerDialog extends AppCompatDialog {
    ...
    public CountryPickerDialog(Context context, CountryPickerCallbacks callbacks,
        ...
        countries = CountryUtils.parseCountries(CountryUtils.getCountriesJSON(this.getContext()));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                callbacks.onCountrySelected(country, CountryUtils.getMipmapResId(getContext(),
                        country.getIsoCode().toLowerCase(Locale.ENGLISH) + "_flag"));
            }
        });

        RelativeLayout cancleImage = (RelativeLayout)findViewById(R.id.img_can_country);
