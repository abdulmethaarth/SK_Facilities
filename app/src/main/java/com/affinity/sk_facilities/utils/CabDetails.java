...
public class CabDetails implements Serializable {
    ...
    public String getArebicCartype(){
        return ArebicCartype;
    }
    public void setArebicCartype(String ArebicCartype){
        this.ArebicCartype = ArebicCartype;
    }
...
//    }
    ...
    public void setArabicDescription(String arb_description){
        this.arb_description = arb_description;
    }

    String arb_description;
    public String getArabicDescription(){
        return arb_description;
    }
