...
public class AllTripFeed implements Serializable {
    ...
    String isUploadReview;
    public String getIsUploadReview() {
        return isUploadReview;
    }

    public void setIsUploadReview(String isUploadReview) {
        this.isUploadReview = isUploadReview;
    }
}
