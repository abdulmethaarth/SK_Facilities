...
import com.affinity.sk_facilities.utils.SimpleRatingBar;
...
public class SingleTripDetailsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user_id = pref.getString(String.valueOf(Constants.user_id), "");
        singleRideDetails();
        ...
        layout_back_arrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intnt = new Intent(SingleTripDetailsActivity.this, MyBookingsActivity.class);
                startActivity(intnt);
            }
        });
    ...
    private void singleRideDetails() {
        ...
        Call<com.affinity.sk_facilities.beens.SingleTripDetails> userCall = api.getSingleTripDetail(user_id,ride_id);
        userCall.enqueue(new Callback<com.affinity.sk_facilities.beens.SingleTripDetails>() {
            @Override
            public void onResponse(Call<com.affinity.sk_facilities.beens.SingleTripDetails> call, retrofit2.Response<com.affinity.sk_facilities.beens.SingleTripDetails> response) {

                com.affinity.sk_facilities.beens.SingleTripDetails baseResponse = response.body();
                if (baseResponse.status.equalsIgnoreCase("true")) {
                    com.affinity.sk_facilities.beens.SingleTripDetails.SingleTrip data = baseResponse.getDetails();
                   ...
                   // int rating=Integer.parseInt(data.getRating());
                    ...
                    mMap.addMarker(new MarkerOptions().position(new LatLng(DropLatitude,DropLongtude)).title("Drop Location.").icon(BitmapDescriptorFactory.fromResource(R.drawable.location_pin_icon)));
            ...
            @Override
            public void onFailure(Call<com.affinity.sk_facilities.beens.SingleTripDetails> call, Throwable t) {
