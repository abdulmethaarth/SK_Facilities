package com.affinity.sk_facilities.adapter;
...
import com.affinity.sk_facilities.utils.ReviewsData;

import com.affinity.sk_facilities.utils.SimpleRatingBar;
import com.affinity.sk_facilities.utils.Url;
...
public class ReviewsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public ReviewsAdapter(Activity act, ArrayList<ReviewsData> trpArray,boolean driveroruser){
        activity = act;
        TripArray = trpArray;
    ...
    private void bindCabDetailFeedItem(final int position, final AllTripViewHolder holder) {
        ...
        if(reviewsData.getDriver_image()!=null){
            if(driveroruser) {
                ...
                Log.e("TaxiBooking","image"+Url.userImageUrl+reviewsData.getDriver_image());

                Picasso.get()
                        .load(Uri.parse(Url.userImageUrl+reviewsData.getDriver_image()))
