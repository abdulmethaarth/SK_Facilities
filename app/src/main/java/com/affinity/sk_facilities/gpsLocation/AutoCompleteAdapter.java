package com.affinity.sk_facilities.gpsLocation;
...
public class AutoCompleteAdapter extends ArrayAdapter implements Filterable {
    ...
    public static ArrayList autocomplete(String input,Activity activity) {
        ...
        StringBuilder jsonResults = new StringBuilder();
            ...
            String locationUrl = "";
            try {
                locationUrl = "https://maps.googleapis.com/maps/api/place/autocomplete/json?key=AIzaSyCk0DR3GiV2nlxvfww93C6ojCa6p9sMUMs" + URLEncoder.encode(input, "UTF-8");
